...
# Copied from: https://github.com/python/cpython/blob/bfd0fbdc1352534b3c91b46dbae4285f5220acf4/Lib/test/support/testresult.py
...
class RegressionTestResult(unittest.TextTestResult):
    ...
    def _add_result(self, test, capture=False, **args):
        ...
        if self.__start_time:
            e.set('time', '{t:0.6f}'.format(t=time.perf_counter() - self.__start_time))
    ...
    def addSkip(self, test, reason):
        ...
        self.__write('S', 'skipped {reason!r}'.format(reason=reason))
